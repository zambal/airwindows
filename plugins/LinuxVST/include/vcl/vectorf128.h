...
// delegate to libmvec
static inline Vec2d sin(Vec2d const a) {
    return _ZGVbN2v_sin(a);
}

// delegate to libmvec
static inline Vec2d cos(Vec2d const a) {
    return _ZGVbN2v_cos(a);
}

// delegate to libmvec
static inline Vec2d exp(Vec2d const a) {
    return _ZGVbN2v_exp(a);
}

// delegate to libmvec
static inline Vec2d log(Vec2d const a) {
    return _ZGVbN2v_log(a);
}

// delegate to libmvec
static inline Vec2d pow(Vec2d const a, Vec2d const b) {
    return _ZGVbN2vv_pow(a, b);
}
