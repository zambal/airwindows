    ...
    AudioEffectX(audioMaster, kNumPrograms, kNumParameters)
{
  ...
  D = 0.5;
	...
	for (int x = 0; x < 13; x++) {biquad_1[x] = 0.0;}
  ...
  // Biquad 2
	...
	for (int x = 0; x < 13; x++) {biquad_2[x] = 0.0;}
  ...
  P = 0.5;
	...
	for(int count = 0; count < 2004; count++) {mpk[count][0] = 0.0; mpk[count][1] = 0.0;}
  ...
  R = 0.5;
	...
	for(int count = 0; count < 222; count++) {hull[count][0] = 0.0; hull[count][1] = 0.0;}
	hullp = 1;
	for (int x = 0; x < 21; x++) pearB[x] = 0.0;
	subA[0] = subA[1] = subB[0] = subB[1] = subC[0] = subC[1] = 0.0;
	midA = midB = 0.0;
	bassA = bassB = 0.0;
	gainA = gainB = 1.0;
  ...
  for(int i = 0; i < 2; ++i) {
	  fpd[i] = 1.0; while (fpd[i] < 16386) fpd[i] = rand()*UINT32_MAX;
  }
